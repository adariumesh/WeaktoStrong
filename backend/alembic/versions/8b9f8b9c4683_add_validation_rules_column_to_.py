...
def upgrade() -> None:
    ...
    op.add_column('challenges', sa.Column('slug', sa.String(length=100), nullable=False))
    op.add_column('challenges', sa.Column('track', sa.String(length=20), nullable=False))
    op.add_column('challenges', sa.Column('validation_rules', sa.JSON(), nullable=True))
    op.add_column('challenges', sa.Column('estimated_time', sa.Integer(), nullable=True))
    ...
    op.add_column('challenges', sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False))
    op.alter_column('challenges', 'difficulty',
               existing_type=postgresql.ENUM('beginner', 'intermediate', 'advanced', name='challenge_difficulty'),
               type_=sa.String(length=20),
               existing_nullable=False)
    op.alter_column('challenges', 'requirements',
               existing_type=postgresql.JSONB(astext_type=sa.Text()),
               type_=sa.JSON(),
               nullable=True,
               existing_server_default=sa.text("'[]'::jsonb"))
    op.alter_column('challenges', 'constraints',
               existing_type=postgresql.JSONB(astext_type=sa.Text()),
               type_=sa.JSON(),
               nullable=True,
               existing_server_default=sa.text("'[]'::jsonb"))
    op.alter_column('challenges', 'test_config',
               existing_type=postgresql.JSONB(astext_type=sa.Text()),
               type_=sa.JSON(),
               nullable=True,
               existing_server_default=sa.text("'{}'::jsonb"))
    ...
    op.alter_column('challenges', 'hints',
               existing_type=postgresql.JSONB(astext_type=sa.Text()),
               type_=sa.JSON(),
               nullable=True,
               existing_server_default=sa.text("'[]'::jsonb"))
    ...
    op.alter_column('conversations', 'model_tier',
    ...
    op.drop_constraint('conversations_challenge_id_fkey', 'conversations', type_='foreignkey')
    ...
    op.add_column('submissions', sa.Column('status', sa.String(length=20), nullable=False))
    op.add_column('submissions', sa.Column('passed', sa.Boolean(), nullable=False))
    op.add_column('submissions', sa.Column('points_earned', sa.Integer(), nullable=False))
    op.add_column('submissions', sa.Column('completion_time', sa.Integer(), nullable=True))
    op.add_column('submissions', sa.Column('submitted_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False))
    ...
    op.alter_column('submissions', 'test_results',
               existing_type=postgresql.JSONB(astext_type=sa.Text()),
               type_=sa.JSON(),
    ...
    op.alter_column('users', 'tokens_used_today',
               existing_type=sa.INTEGER(),
               nullable=False,
               existing_server_default=sa.text('0'))
...
def downgrade() -> None:
    ...
    op.alter_column('users', 'name',
               ...
               existing_nullable=False)
    op.add_column('submissions', sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True))
    ...
    op.create_foreign_key('submissions_challenge_id_fkey', 'submissions', 'challenges', ['challenge_id'], ['id'])
    op.create_index('idx_submissions_user_challenge', 'submissions', ['user_id', 'challenge_id'], unique=False)
    op.alter_column('submissions', 'test_results',
    ...
    op.add_column('conversations', sa.Column('tokens_used', sa.INTEGER(), server_default=sa.text('0'), autoincrement=False, nullable=True))
    op.add_column('conversations', sa.Column('messages', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'[]'::jsonb"), autoincrement=False, nullable=False))
    op.drop_constraint(None, 'conversations', type_='foreignkey')
    op.create_foreign_key('conversations_challenge_id_fkey', 'conversations', 'challenges', ['challenge_id'], ['id'])
    ...
    op.add_column('challenges', sa.Column('track_id', sa.UUID(), autoincrement=False, nullable=False))
    op.add_column('challenges', sa.Column('is_red_team', sa.BOOLEAN(), server_default=sa.text('false'), autoincrement=False, nullable=True))
    op.add_column('challenges', sa.Column('estimated_time_minutes', sa.INTEGER(), server_default=sa.text('30'), autoincrement=False, nullable=True))
    op.add_column('challenges', sa.Column('model_tier', postgresql.ENUM('local', 'haiku', 'sonnet', name='model_tier'), autoincrement=False, nullable=False))
    op.create_foreign_key('challenges_track_id_fkey', 'challenges', 'tracks', ['track_id'], ['id'])
    op.drop_constraint(None, 'challenges', type_='unique')
    op.create_index('idx_challenges_track_order', 'challenges', ['track_id', 'order_index'], unique=False)
    op.alter_column('challenges', 'created_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               nullable=True,
               existing_server_default=sa.text('CURRENT_TIMESTAMP'))
    ...
    op.alter_column('challenges', 'difficulty',
               existing_type=sa.String(length=20),
               type_=postgresql.ENUM('beginner', 'intermediate', 'advanced', name='challenge_difficulty'),
               existing_nullable=False)
    ...
    sa.Column('status', postgresql.ENUM('not_started', 'in_progress', 'completed', name='progress_status'), server_default=sa.text("'not_started'::progress_status"), autoincrement=False, nullable=True),
    ...
    sa.Column('best_score', sa.INTEGER(), server_default=sa.text('0'), autoincrement=False, nullable=True),
    sa.Column('completed_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['challenge_id'], ['challenges.id'], name='progress_challenge_id_fkey'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='progress_user_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='progress_pkey'),
    sa.UniqueConstraint('user_id', 'challenge_id', name='progress_user_id_challenge_id_key')
    )
    op.create_index('idx_progress_user_challenge', 'progress', ['user_id', 'challenge_id'], unique=False)
